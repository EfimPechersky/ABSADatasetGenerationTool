...
from Backend.Storage.OperationsTable import Operation
from Backend.Storage.Statuses import OperationStatus
from Backend.Storage.OperationTypesTable import OperationType
from Backend.Storage.ProjectsTable import Project
from Backend.Storage.UserTable import User
from Backend.Storage.ModelTrainTable import ModelTraining
from Backend.Storage.TrainingQueue import Queue
...
class DatabaseManager:
    ...
    def __init__(self):
        ...
        self.engine = create_engine(os.getenv("DATABASE_URL", f"postgresql://{DB_USER}:{DB_PASSWORD}@{DB_HOST}:{DB_PORT}/{DB_NAME}"))
